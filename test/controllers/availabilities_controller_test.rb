...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { description: @availability.description, title: @availability.title } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { description: @availability.description, title: @availability.title } }
